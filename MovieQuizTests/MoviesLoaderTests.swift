...
//  MovieQuizTests
//
//  Created by Ilman on 06.12.2025.
//
...
class MoviesLoaderTests: XCTestCase {
    ...
    func testSuccerssLoading() throws {
        // Give
        let stupNetworkClient = StubNetworkClient(emulateError: false)
        let loader = MoviesLoader(networkClient: stupNetworkClient)
        //When
    ...
    func testFailuerLoading() throws {
        //Give
